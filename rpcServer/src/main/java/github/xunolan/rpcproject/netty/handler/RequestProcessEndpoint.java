...
//    private static final Logger log = LoggerFactory.getLogger(RequestProcessEndpoint.class);
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        Object serviceInstance = LocalServiceRecord.getServiceInstanceByName(rpcRequest.getClassName());
        ...
        if(ObjectUtil.isNotNull(clazz) && clazz != null) {
            ...
            if(ObjectUtil.isNotNull(method)){
                Object invokeResult = method.invoke(serviceInstance, rpcRequest.getParamValue());
